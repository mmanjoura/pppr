                ...
                <nav className="panel-left">
                    ...
                    <div className="form-group">
                        ...
                        <select id="cars" name="acquirers" className="input-control" style={{ flex: '0.7' }}>
                            <option>Amount-Fees</option>
                            <option>Rebate-Acquirer</option>
                            <option>Acquirer-Transactions</option>
                            <option>DCC-Local</option>
                            <option>Transactions-Region</option>
                            <option>ChargeBack-Region</option>
